...
exports.PROMPTS = exports.SYSTEM_PROMPT_BASE = void 0;
...
`.trim();
exports.PROMPTS = {
    summarizeDocument: (docTitle, content) => `
...
---
`.trim(),
    extractProposalAssumptions: (content) => `
...
`.trim(),
    answerProjectQuestion: (question, projectContext) => `
...
---
`.trim(),
    summarizeProjectStatus: (projectContext) => `
